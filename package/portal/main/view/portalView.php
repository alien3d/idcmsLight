            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
                        <?php   $totalApplication=count($application); 
                    ...
                    <div class="nav-collapse">
                        <ul class="nav">
                            ...
                            for($i=0;$i<$totalApplication;$i++) { 
                            ?> 
                            <li class="active"><a href="#" onClick=loadBelow('full','<?php echo $application[$i]['applicationId']; ?>')><?php echo $application[$i]['applicationNative']; ?></a></li>
                            <li class="dropdown">
                    ...
                    <div class="sidebar-nav">
                        ...
                        <ul class="nav nav-list">
                            ...
                            <li  id="common1" class="hide"><ul class="nav nav-list">
                                    <?php   $totalLeaf  = count($folder['detail']);
