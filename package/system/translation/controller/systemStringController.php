<?php
namespace Core\System\Translation\SystemString\Controller;
session_start ();
...
class SystemStringClass extends ConfigClass {
	...
	function execute() {
		...
		$this->model = new \Core\System\Translation\SystemString\Model\SystemStringModel();
...
if (isset ( $_POST ['method'] )) {
	...
	if (isset($_POST ['databaseRequest'])) {
		$systemStringObject->setRequestDatabase($_POST ['databaseRequest']);
	}
	/*
	 *  Paging
	 */
