 ...
 */
class ReligionClass extends \Core\ConfigClass {
	...
	function execute() {
		...
		$this->model = new \Core\System\Common\Religion\Model\ReligionModel();
	...
	function update() {
		...
		if ($total == 0) {
			...
			if ($this->getVendor() == self::MYSQL) {
				$sql = "
				UPDATE		`religion`
				SET 		`religionCode`		=	'" . $this->model->getReligionCode() . "',
							`religionDesc`			=	'" . $this->model->getReligionDesc() . "',
...
if (isset($_POST ['method'])) {
	...
	if (isset($_POST ['databaseRequest'])) {
		$religionObject->setRequestDatabase($_POST ['databaseRequest']);
	}
	/*
	 *  Paging
	 */
	...
	if (isset($_POST ['character'])) {
		$religionObject->setCharacterQuery($_POST['character']);
	}
	if (isset($_POST ['dateRangeStart'])) {
		$religionObject->setDateRangeStartQuery($_POST['dateRangeStart']);
	}
	if (isset($_POST ['dateRangeEnd'])) {
		$religionObject->setDateRangeEndQuery($_POST['dateRangeEnd']);
	}
	if (isset($_POST ['dateRangeType'])) {
		$religionObject->setDateRangeTypeQuery($_POST['dateRangeType']);
	}
	/*
	 * Ordering
	 */
...
if (isset($_GET ['method'])) {
	...
	if (isset($_GET ['databaseRequest'])) {
		$religionObject->setRequestDatabase($_GET ['databaseRequest']);
	}
	/*
	 *  Load the dynamic value
	 */
