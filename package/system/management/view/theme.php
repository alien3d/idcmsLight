...
if (isset($_POST)) {  
    if (isset($_POST['method'])) {  
        $theme = new \Core\System\Management\Theme\Controller\themeClass();  
        ...
        if ($_POST['method'] == 'read') {  
            ...
            $theme = $theme->read();  
            if (isset($theme [0]['firstRecord'])) {  
                $firstRecord = $theme [0]['firstRecord'];  
            }  
            if (isset($theme [0]['nextRecord'])) {  
                $nextRecord = $theme [0]['nextRecord'];  
            }   
            if (isset($theme [0]['previousRecord'])) {  
                $previousRecord = $theme [0]['previousRecord'];  
            }   
            if (isset($theme [0]['lastRecord'])) {  
                $lastRecord = $theme [0]['lastRecord'];  
                $endRecord = $theme [0]['lastRecord'];  
           }   
...
<div align='right'> 
        ...
        <a href='javascript:void(0)' class='btn' onClick='showForm('<?php $midnightMarket->getViewPath(); ?>','<?php echo $securityToken; ?>')'><i class='icon-plus'></i> New </a> 
              ...
              if (is_array($themeArray)) { 
                ...
                if ($totalRecord > 0) { 
                    for ($i = 0; $i < $totalRecord; $i++) { ?> 
                        <tr> 
 <th>Action</th> 
switch($themeArray['themeSequence'][$i]) { ?> 
 case 'isDefault':
...
<th><?php $themeArray[$i]['themeSequence'];  ?></th> 
}
...
<th><?php $themeArray[$i]['themeSequence'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['themeCode'];  ?></th> 
}
...
<th><?php $themeArray[$i]['themeCode'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['themeNote'];  ?></th> 
}
...
<th><?php $themeArray[$i]['themeNote'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['themePath'];  ?></th> 
}
...
<th><?php $themeArray[$i]['themePath'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['isDefault'];  ?></th> 
}
...
<th><?php $themeArray[$i]['isNew'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['isDraft'];  ?></th> 
}
...
<th><?php $themeArray[$i]['isDraft'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['isUpdate'];  ?></th> 
}
...
<th><?php $themeArray[$i]['isUpdate'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['isDelete'];  ?></th> 
}
...
<th><?php $themeArray[$i]['isDelete'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['isActive'];  ?></th> 
}
                ...
                default:
<th><?php $themeArray[$i]['isActive'];  ?></th> 
 } switch($themeArray['isApproved'][$i]) { ?> 
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['isApproved'];  ?></th> 
}
...
<th><?php $themeArray[$i]['isApproved'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['isReview'];  ?></th> 
}
...
<th><?php $themeArray[$i]['isPost'];  ?></th> 
 ...
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['executeBy'];  ?></th> 
}
                ...
                default:
<th><?php $themeArray[$i]['executeBy'];  ?></th> 
 } switch($themeArray['executeTime'][$i]) { ?> 
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<th><?php $themeArray[$i]['executeTime'];  ?></th> 
}
...
switch($themeArray[$i]['themeSequence']) { ?> 
 case 'isDefault':
                ...
                case 'isPost':
                    ...
                    if($_SESSION ['isAdmin'] ==1) {
<td><?php $theme[$i]['themeSequence'];  ?></td> 
}
...
<div class='control-group' id='dateDiv'>
    ...
    onClick='<?php if($leafAccess['isDraft']==1?>) { ?>auditRecord()<?php } ?>'><i class='icon-warning-sign icon-white'></i><?php echo $button['isAuditLabel']; ?></a> 
            ...
            <ul class='dropdown-menu'> 
                <li><a  name='newRecordButton3' id='newRecordButton3'   href='javascript:void(0)' onClick='<?php if($leafAccess['isNew']==1) { ?>newRecord(1) <?php } ?>' class='disabled'><i class='icon-plus'></i><?php echo $button['isNewLabel'][0]; ?></a></li> 
                <li><a  name='newRecordButton4' id='newRecordButton4'   href='javascript:void(0)' onClick='<?php if($leafAccess['isNew']==1) { ?>newRecord(2) <?php } ?>' class='disabled'><i class='icon-edit'></i><?php echo $button['isNewLabel'][1]; ?></a></li> 
                <li><a  name='newRecordButton5' id='newRecordButton5'   href='javascript:void(0)' onClick='<?php if($leafAccess['isNew']==1) { ?>newRecord(3) <?php } ?>' class='disabled'><i class='icon-print'></i><?php echo $button['isNewLabel'][2]; ?></a></li> 
                <li><a  name='newRecordButton6' id='newRecordButton6'    href='javascript:void(0)' onClick='<?php if($leafAccess['isNew']==1) { ?>newRecord(4) <?php } ?>' class='disabled'><i class='icon-print'></i><?php echo $button['isNewLabel'][3]; ?></a></li> 
                <li><a  name='newRecordButton7' id='newRecordButton7'    href='javascript:void(0)' onClick='<?php if($leafAccess['isNew']==1) { ?>newRecord(5) <?php } ?>' class='disabled'><i class='icon-list'></i><?php echo $button['isNewLabel'][4]; ?></a></li> 
            </ul> 
        </div> 
        <div class='btn-group'> 
            ...
            <ul class='dropdown-menu'> 
                <li><a  name='updateRecordButton3' id='updateRecordButton'    href='javascript:void(0)'  onClick='<?php if($leafAccess['isUpdate']==1) { ?>updateRecord(1)<?php } ?>' class='disabled <?php } ?>'><i class='icon-plus'></i><?php echo $button['isUpdateLabel'][0]; ?></a></li> 
                <li><a  name='updateRecordButton4' id='updateRecordButton'    href='javascript:void(0)' onClick='<?php if($leafAccess['isUpdate']==1) { ?>updateRecord(2)<?php } ?>' class='disabled <?php } ?>'><i class='icon-print'></i><?php echo $button['isUpdateLabel'][1]; ?></a></li> 
               <li><a  name='updateRecordButton5' id='updateRecordButton'    href='javascript:void(0)' onClick='<?php if($leafAccess['isUpdate']==1) { ?>updateRecord(3)<?php } ?>' class='disabled <?php } ?>'><i class='icon-list-alt'></i><?php echo $button['isUpdateLabel'][2]; ?></a></li> 
            </ul> 
        </div> 
        <div class='btn-group'> 
        ...
        <div class='btn-group'>            <a  name='listRecordButton' id='listRecordButton' href='javascript:void(0)' class='btn btn-info' onClick='showGrid('<?php $theme->getViewPath(); ?>','<?php echo $securityToken; ?>',0,<?php 'LIMIT; ?>)'><i class='icon-list icon-white'></i>Listing</a> 
        </div> 
        <div class='btn-group'> 
...
<?php } ?> 
<script language='javascript' type='text/javascript' src='./package/system/management/theme/javascript/original/theme.js'></script> 