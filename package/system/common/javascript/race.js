...
,                 message         :	message
	...
	function showFormUpdate(url, securityToken, raceId) {
         $('a[rel=tooltip]').tooltip('hide');           // unlimited for searching because  lazy paging.
         $.ajax({
             type	:   'POST',
    		url	:   url,
		data	:   {
...
//    });
 ...
 function newRecord(url, securityToken, type,updateAccess,deleteAccess) {
...
if(updateAccess == 1) {
	...
	$('#updateRecordButton3').attr('onClick', "updateRecord(\""+url+"\",\""+securityToken+"\",\""+1+"\",\""+updateAccess+"\",\""+deleteAccess+"\")"); 
	$('#updateRecordButton4').attr('onClick', "updateRecord(\""+url+"\",\""+securityToken+"\",\""+2+"\",\""+updateAccess+"\",\""+deleteAccess+"\")"); 
	$('#updateRecordButton5').attr('onClick', "updateRecord(\""+url+"\",\""+securityToken+"\",\""+3+"\",\""+updateAccess+"\",\""+deleteAccess+"\")"); 
} else {
 ...
 if(deleteAccess==1) {
     ...
     $('#deleteRecordButton').attr('onClick', "deleteRecord(\""+url+"\",\""+securityToken+"\",\""+deleteAccess+"\")"); 
 } else {
     $('#deleteRecordButton').removeClass(); 
     $('#deleteRecordButton').addClass('btn btn-danger'); 
...
if(updateAccess == 1) {
 ...
 if(deleteAccess==1) {
	...
	function updateRecord(url, securityToken, type,deleteAccess) {
 ...
 if(deleteAccess==1) {
	...
	function firstRecord(url, securityToken,updateAccess,deleteAccess) {
		...
		$('#raceDesc').val(data.data.raceDesc);
                                     if (data.nextRecord > 0) {
                                         ...
                                         $('#nextRecordButton').attr('onClick', "nextRecord(\""+url+"\",\""+securityToken+"\",\""+updateAccess+"\",\""+deleteAccess+"\")"); 
...
if(updateAccess == 1) {
 ...
 if(deleteAccess==1) {
	...
	function lastRecord(url, securityToken,updateAccess,deleteAccess) {
                            		...
                            		if (data.lastRecord != 0) {
                               		$('#previousRecordButton').removeClass();
                                		$('#previousRecordButton').addClass('btn btn-info');
                                             $('#previousRecordButton').attr('onClick', "previousRecord(\""+url+"\",\""+securityToken+"\",\""+updateAccess+"\",\""+deleteAccess+"\")"); 
                               		$('#nextRecordButton').removeClass();
...
if(updateAccess == 1) {
 ...
 if(deleteAccess==1) {
	...
	function previousRecord(url, securityToken,updateAccess,deleteAccess) {
...
if(updateAccess == 1) {
 ...
 if(deleteAccess==1) {
	...
	function nextRecord(url, securityToken,updateAccess,deleteAccess) {
