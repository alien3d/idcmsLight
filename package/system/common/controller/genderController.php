 ...
 */
class GenderClass extends \Core\ConfigClass {
	...
	function execute() {
		...
		$this->model =new \Core\System\Common\Gender\Model\GenderModel();
...
if (isset($_POST ['method'])) {
	...
	if (isset($_POST ['databaseRequest'])) {
		$genderObject->setRequestDatabase($_POST ['databaseRequest']);
	}
	/*
	 *  Paging
	 */
