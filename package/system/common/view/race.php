...
<?php
require_once('/../controller/raceController.php');
$dateStartRange = null;
$dateEndRange = null;
...
if ($_POST['method'] == 'read' && $_POST['type'] == 'list') {
    ...
    <div  id='leftViewportDetail' class='well span2'> 
        ...
        <hr>
        <h3>Search</h3>
        <input type='text' name='queryWidget' id='queryWidget' class='span2' value='<?php if (isset($_POST['query'])) {
        echo $_POST['query'];
    } ?>'>
        ...
        <div style='style:none'>
            <input type='date' name='dateRangeStart' id='dateRangeStart' class='span2' value='<?php if (isset($_POST['dateRangeStart'])) {
        echo $_POST['dateRangeStart'];
    } ?>'><br>
            <input type='date' name='dateRangeEnd' id='dateRangeEnd' class='span2' value='<?php if (isset($_POST['dateRangeEnd'])) {
        ...
        <table>
            ...
            <tr>
                <td>Filter Date</td>
                <td>:</td>
                <td><?php if (isset($_POST['dateRangeStart'])) {
        echo $_POST['dateRangeStart'];
    } ?> <?php if (isset($_POST['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
        echo 'till  ' . $_POST['dateRangeEnd'];
    } ?> </td>
            </tr>
            <tr>
                <td>Filter Method </td>
                <td>:</td>
                <td><?php if (isset($_POST['dateRangeType'])) {
        echo $_POST['dateRangeType'];
    } ?></td>
            </tr>
            <tr>
                <td>Filter Type </td>
                <td>:</td>
                <td><?php if (isset($_POST['dateRangeExtraType'])) {
        echo $_POST['dateRangeExtraType'];
    } ?></td>
            </tr>
        </table>            </div>
    <div name='rightViewport' id='rightViewport' class='span13'>
        ...
        <div  class='modal hide fade' id='filterGridAdvance'>  
            ...
            <div class='modal-body'>  
                <div class='control-group' id='raceSequenceDiv' >
                    ...
                    <label class='control-label'><?php if (isset($leafTranslation['raceSequenceLabel'])) {
        echo $leafTranslation['raceSequenceLabel'];
    } ?></label>
                ...
                <div class='control-group' id='raceCodeDiv'>
                    <label class='control-label'><?php if (isset($leafTranslation['raceCodeLabel'])) {
        echo $leafTranslation['raceCodeLabel'];
    } ?></label>
                    <div class='controls  input-prepend'>
                    ...
                    <label class='control-label'><?php if (isset($leafTranslation['raceDescLabel'])) {
        echo $leafTranslation['raceDescLabel'];
    } ?></label>
                    <div class='controls  input-prepend'>
        ...
        <div align='left'  class='btn-group'> 
            ...
            <a title='Z' href=javascript:void(0) class='btn btn-small' onClick=ajaxQuerySearchAllCharacter('<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>','Z')>Z</a> 
                ...
                <div class='alert alert-error'><a class='close' data-dismiss='alert'>x</a>uiks<?php echo $_POST['message']; ?></div>
                <?php } ?></div> 
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
    ...
    ?>'> 
        <div class='control-group' id='raceSequenceForm' >
            ...
            <div class='controls  input-prepend'>
                ...
                <input type='text' name='raceSequence' id='raceSequence' placeholder='Numeric Only' class='span3' value='<?php if (isset($raceArray) && is_array($raceArray)) {
                    echo $raceArray[0]['raceSequence'];
                } ?>'>
        ...
        <div class='control-group' id='raceCodeForm'>
            ...
            <div class='controls  input-prepend'>
                <input type='text' name='raceCode' id='raceCode' placeholder='Field Of raceCode' class='span3' 
                       value='<?php if (isset($raceArray) && is_array($raceArray)) {
                    echo $raceArray[0]['raceCode'];
                } ?>'>
            </div>
    ...
    <?php if ($leafAccess['isDraft'] == 1) { ?>) { ?>onClick=auditRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>',)<?php } ?>><i class='icon-warning-sign icon-white'></i><?php echo $buttonTranslation['isAuditLabel']; ?></a> 
                ...
                <ul class='dropdown-menu'> 
                    <li><a name='newRecordButton3' id='newRecordButton3' href=javascript:void(0) <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>onClick=newRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>',1) <?php } ?> class='<?php if ($leafAccess['isNew'] == 0) { ?>disabled<?php } ?>'><i class='icon-plus'></i><?php echo $buttonTranslation['isNewLabel'][1]; ?></a></li> 
                    <li><a name='newRecordButton4' id='newRecordButton4' href=javascript:void(0) <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>onClick=newRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>',2) <?php } ?> class='<?php if ($leafAccess['isNew'] == 0) { ?>disabled<?php } ?>'><i class='icon-edit'></i><?php echo $buttonTranslation['isNewLabel'][2]; ?></a></li> 
                    <li><a name='newRecordButton5' id='newRecordButton5' href=javascript:void(0) <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>onClick=newRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>',3) <?php } ?> class='<?php if ($leafAccess['isNew'] == 0) { ?>disabled<?php } ?>'><i class='icon-print'></i><?php echo $buttonTranslation['isNewLabel'][3]; ?></a></li> 
                    <li><a name='newRecordButton6' id='newRecordButton6' href=javascript:void(0) <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>onClick=newRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>',4) <?php } ?> class='<?php if ($leafAccess['isNew'] == 0) { ?>disabled<?php } ?>'><i class='icon-print'></i><?php echo $buttonTranslation['isNewLabel'][4]; ?></a></li> 
                    <li><a name='newRecordButton7' id='newRecordButton7' href=javascript:void(0) <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>onClick=newRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>',5) <?php } ?> class='<?php if ($leafAccess['isNew'] == 0) { ?>disabled<?php } ?>'><i class='icon-list'></i><?php echo $buttonTranslation['isNewLabel'][5]; ?></a></li> 
                </ul> 
            </div> 
            <div class='btn-group'> 
            ...
            <div class='btn-group'>            <a name='resetRecordButton' id='resetRecordButton' href=javascript:void(0) class='btn btn-info' onClick=resetRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>')><i class=icon-refresh icon-white></i><?php echo $buttonTranslation['isResetLabel']; ?></a> 
            </div> 
            ...
            <div class='btn-group'> 
                <a name='firstRecordButton' id='firstRecordButton' href=javascript:void(0) class='btn btn-info' onClick=firstRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>')><i class=icon-fast-backward icon-white></i><?php echo $defaultTranslation['firstButtonLabel']; ?></a> 
            </div> 
            <div class='btn-group'> 
                <a name='previousRecordButton' id='previousRecordButton' href=javascript:void(0) class='btn btn-info disabled' onClick=previousRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>')><i class=icon-backward icon-white></i><?php echo $defaultTranslation['previousButtonLabel']; ?></a> 
            </div> 
            <div class='btn-group'> 
                <a name='nextRecordButton' id='nextRecordButton' href=javascript:void(0) class='btn btn-info disabled' onClick=nextRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>')><i class=icon-forward icon-white></i><?php echo $defaultTranslation['nextButtonLabel']; ?></a> 
            </div> 
            <div class='btn-group'> 
                <a name='lastRecordButton' id='lastRecordButton' href=javascript:void(0) class='btn btn-info' onClick=lastRecord('<?php echo $race->getControllerPath(); ?>','<?php echo $securityToken; ?>')><i class=icon-fast-forward icon-white></i><?php echo $defaultTranslation['endButtonLabel']; ?></a> 
            </div> 
        </div></div> 
    <input type='hidden' name='x' id='x'> 
    <input type='hidden' name='firstRecord' id='firstRecord' value='<?php if (isset($firstRecord)) {
        echo $firstRecord;
    } ?>'> 
    <input type='hidden' name='nextRecord' id='nextRecord' value='<?php if (isset($nextRecord)) {
        echo $nextRecord;
    } ?>'> 
    <input type='hidden' name='previousRecord' id='previousRecord' value='<?php if (isset($previousRecord)) {
        echo $previousRecord;
    } ?>'> 
    <input type='hidden' name='lastRecord' id='lastRecord' value='<?php if (isset($lastRecord)) {
        echo $lastRecord;
    } ?>'> 
    <input type='hidden' name='endRecord' id='endRecord' value='<?php if (isset($endRecord)) {
        echo $endRecord;
    } ?>'> 
    <script language='javascript' type='text/javascript'> 
        $(document).ready(function(){  
