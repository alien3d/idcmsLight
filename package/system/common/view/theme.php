    ...
    <div name='rightViewport' id='rightViewport' class='span13'>
        ...
        <div  class='modal hide fade' id='filterGridAdvance'>  
            ...
            <div class='modal-body'>  
                <div class='control-group' id='themeSequenceDiv' >
                    ...
                    <label class='control-label'><?php if (isset($themeSequence)) {
        echo $leafTranslation['themeSequenceLabel'];
    } ?></label>
                ...
                <div class='control-group' id='themeCodeDiv'>
                    <label class='control-label'><?php if (isset($themeCode)) {
        echo $leafTranslation['themeCodeLabel'];
    } ?></label>
                    <div class='controls  input-prepend'>
                    ...
                    <label class='control-label'><?php if (isset($themeNote)) {
        echo $leafTranslation['themeNoteLabel'];
    } ?></label>
                    <div class='controls  input-prepend'>
                    ...
                    <label class='control-label'><?php if (isset($themePath)) {
        echo $leafTranslation['themePathLabel'];
    } ?></label>
                    <div class='controls  input-prepend'>
        ...
        <table class='table table-striped table-bordered table-condensed' name='tableData' id='tableData'> 
            ...
            if ($_SESSION ['isAdmin'] == 1) {
                ...
                ?>
                    <th>Delete<input  class='check_all' type='checkbox' name='check_all' id='check_all' alt='Check Record' onclick=toggleChecked(this.checked)></th>
                </tr> 
            </thead> 
            <tbody id=tableBody> 
                <?php
		...
		<a rel='tooltip' class='tooltip-top btn btn-warning' data-original-title='Edit' onClick=showFormUpdate('" . $theme->getViewPath();
                                ?>','<?php echo $securityToken; ?>','<?php
                    echo intval($themeArray [$i]['themeId']) . "')><i class='icon-edit icon-white'></i></a>  
...
<input type='checkbox' name=themeId[] id='themeId' value='" . $themeArray[$i]['themeId'] . "' style='display:none;'>
<input type='checkbox' name=isDelete[] id='isDelete' value='" . $themeArray[$i]['isDelete'] . "' ".$checked."></td>";
                    echo "</tr>";
                }
            }
        } else {
    ...
    ?> 
       ...
       if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
        ...
        <div class='pull-right'> 
            <button class='delete btn btn-warning' type='button' onClick=deleteGridRecordCheckbox('<?php echo $theme->getControllerPath(); ?>','<?php echo $securityToken; ?>','<?php echo $theme->getViewPath(); ?>')> 
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
    ...
    <div class='control-group' id='themeSequenceForm' >
        ...
        <div class='controls  input-prepend'>
            ...
            <input type='text' name='themeSequence' id='themeSequence' placeholder='Numeric Only' class='span3' value='<?php if (isset($themeArray) && is_array($themeArray)) {
        echo $themeArray[0]['themeSequence'];
    } ?>'>
    ...
    <div class='control-group' id='themeCodeForm'>
        ...
        <div class='controls  input-prepend'>
            <input type='text' name='themeCode' id='themeCode' placeholder='Field Of themeCode' class='span3' 
                   value='<?php if (isset($themeArray) && is_array($themeArray)) {
        echo $themeArray[0]['themeCode'];
    } ?>'>
        </div>
        ...
        <div class='controls  input-prepend'>
            ...
            <input type='text' name='executeBy' id='executeBy' placeholder='String Only' class='span3' value='<?php if (isset($themeArray) && is_array($themeArray)) {
        echo $themeArray[0]['staffName'];
    } ?>' readOnly>
    ...
    ?><div class='control-group' id='executeTimeForm'>
        ...
        <div class='controls input-prepend'>
            ...
            <input type='date' name='executeTime' id='executeTime' placeholder='Date Validation' class='span3' value='<?php if (isset($value)) {
        echo $value;
    } ?>' readOnly>
