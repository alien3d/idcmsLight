 ...
 */
class ReligionModel extends \Core\Validation\ValidationClass {
	...
	public function execute() {
		...
		if(isset($_POST['religionDesc'])){
			$this->setReligionDesc($this->strict($_POST['religionDesc'],'string'));
		}
	 ...
	 * @param $religionDesc
	 */
	public function setReligionDesc($religionDesc)
	{
