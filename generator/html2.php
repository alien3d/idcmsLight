...
$str.="                <li><a name='newRecordButton3' id='newRecordButton3' href=javascript:void(0) <?php if(\$leafAccess['isNew']==1) { ?>onClick=newRecord('<?php echo \$" . $data[0]['tableName'] . "->getControllerPath(); ?>','<?php echo \$securityToken; ?>',1) <?php } ?> class='<?php if(\$leafAccess['isNew']==0) { ?>disabled<?php } ?>'><i class='icon-plus'></i><?php echo \$buttonTranslation['isNewLabel'][1]; ?></a></li> \n";
$str.="                <li><a name='newRecordButton4' id='newRecordButton4' href=javascript:void(0) <?php if(\$leafAccess['isNew']==1) { ?>onClick=newRecord('<?php echo \$" . $data[0]['tableName'] . "->getControllerPath(); ?>','<?php echo \$securityToken; ?>',2) <?php } ?> class='<?php if(\$leafAccess['isNew']==0) { ?>disabled<?php } ?>'><i class='icon-edit'></i><?php echo \$buttonTranslation['isNewLabel'][2]; ?></a></li> \n";
$str.="                <li><a name='newRecordButton5' id='newRecordButton5' href=javascript:void(0) <?php if(\$leafAccess['isNew']==1) { ?>onClick=newRecord('<?php echo \$" . $data[0]['tableName'] . "->getControllerPath(); ?>','<?php echo \$securityToken; ?>',3) <?php } ?> class='<?php if(\$leafAccess['isNew']==0) { ?>disabled<?php } ?>'><i class='icon-print'></i><?php echo \$buttonTranslation['isNewLabel'][3]; ?></a></li> \n";
$str.="                <li><a name='newRecordButton6' id='newRecordButton6' href=javascript:void(0) <?php if(\$leafAccess['isNew']==1) { ?>onClick=newRecord('<?php echo \$" . $data[0]['tableName'] . "->getControllerPath(); ?>','<?php echo \$securityToken; ?>',4) <?php } ?> class='<?php if(\$leafAccess['isNew']==0) { ?>disabled<?php } ?>'><i class='icon-print'></i><?php echo \$buttonTranslation['isNewLabel'][4]; ?></a></li> \n";
$str.="                <li><a name='newRecordButton7' id='newRecordButton7' href=javascript:void(0) <?php if(\$leafAccess['isNew']==1) { ?>onClick=newRecord('<?php echo \$" . $data[0]['tableName'] . "->getControllerPath(); ?>','<?php echo \$securityToken; ?>',5) <?php } ?> class='<?php if(\$leafAccess['isNew']==0) { ?>disabled<?php } ?>'><i class='icon-list'></i><?php echo \$buttonTranslation['isNewLabel'][5]; ?></a></li> \n";
$str.="            </ul> \n";
$str.="        </div> \n";
$str.="        <div class='btn-group'> \n";
$str.="            <a  name='updateRecordButton1' id='updateRecordButton1' href=javascript:void(0) class='<?php if(\$leafAccess['isUpdate']==0) { ?>btn btn-info 	disabled<?php } else { ?>btn btn-info <?php } ?>'><i class=icon-edit icon-white></i><?php echo \$buttonTranslation['isUpdateLabel'][0]; ?></a> \n";
$str.="            <a  name='updateRecordButton2' id='updateRecordButton2' href=javascript:void(0) data-toggle='dropdown' class='<?php if(\$leafAccess['isUpdate']==0) { ?>btn dropdown-toggle btn-info disabled<?php } else { ?>btn dropdown-toggle btn-info <?php } ?>'><span class='caret'></span></a> \n";
$str.="            <ul class='dropdown-menu'> \n";
$str.="                <li><a name='updateRecordButton3' id='updateRecordButton3' href=javascript:void(0) <?php if(\$leafAccess['isUpdate']==1) { ?>onClick=updateRecord('<?php echo \$" . $data[0]['tableName'] . "->getControllerPath(); ?>','<?php echo \$securityToken; ?>',1)<?php } ?> class='<?php if(\$leafAccess['isUpdate']==0) { ?>disabled <?php } ?>'><i class='icon-plus'></i><?php echo \$buttonTranslation['isUpdateLabel'][1]; ?></a></li> \n";
$str.="                <li><a name='updateRecordButton4' id='updateRecordButton4' href=javascript:void(0) <?php if(\$leafAccess['isUpdate']==1) { ?>onClick=updateRecord('<?php echo \$" . $data[0]['tableName'] . "->getControllerPath(); ?>','<?php echo \$securityToken; ?>',2)<?php } ?> class='<?php if(\$leafAccess['isUpdate']==0) { ?>disabled <?php } ?>'><i class='icon-print'></i><?php echo \$buttonTranslation['isUpdateLabel'][2]; ?></a></li> \n";
$str.="                <li><a name='updateRecordButton5' id='updateRecordButton5' href=javascript:void(0) <?php if(\$leafAccess['isUpdate']==1) { ?>onClick=updateRecord('<?php echo \$" . $data[0]['tableName'] . "->getControllerPath(); ?>','<?php echo \$securityToken; ?>',3)<?php } ?> class='<?php if(\$leafAccess['isUpdate']==0) { ?>disabled <?php } ?>'><i class='icon-list-alt'></i><?php echo \$buttonTranslation['isUpdateLabel'][3]; ?></a></li> \n";
$str.="            </ul> \n";
$str.="        </div> \n";
$str.="        <div class='btn-group'> \n";
