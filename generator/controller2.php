...
$str.="			\$sql.=\$this->q->dateFilter(\$sql, \$this->model->getTableName(),\$this->model->getFilterDate(),\$this->getDateRangeStartQuery(),\$this->getDateRangeEndQuery(),\$this->getDateRangeTypeQuery()); \n";
$str.="		} \n";
$str.="		/** \n";
